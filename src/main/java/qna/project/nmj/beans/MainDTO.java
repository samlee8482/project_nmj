...
//	private int store_uid;
	...
	public MainDTO(int store_uid, int mb_uid, String store_name, String store_address, String store_tel,
			...
			int store_dtype, Timestamp store_regDate, int store_ratings, int store_rateCount, double totalAvg,
			int review_uid, int review_rate, String review_content, int review_ban, int review_viewCount,
