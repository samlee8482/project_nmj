...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800" style="margin-top: 30px; margin-bottom: 30px; font-size: 1.5em;">댓글 신고</h1>
	...
	<u><strong>내용</strong></u><br> ${dto.reply_content }<br><br>
	<u><strong>작성일</strong></u><br> ${dto.reply_date }<br>
	<br>
	</div>

    <button class="btn btn-outline-primary" onclick="location.href='deleteReply2.nmj?reply_uid=${dto.reply_uid}&request_uid=${request_uid }'">삭제하기</button>
